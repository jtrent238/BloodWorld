...
public class MCreatorBlockBloodPurifier extends bloodworld.ModElement {

	@GameRegistry.ObjectHolder("bloodworld:blockbloodpurifier")
	public static final Block block = null;

	public MCreatorBlockBloodPurifier(bloodworld instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("bloodworld:blockbloodpurifier",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public BlockCustom() {
			super(Material.IRON);
			setRegistryName("blockbloodpurifier");
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			Block block = this;
			{
				...
				MCreatorBlockBloodPurifierUpdateTick.executeProcedure($_dependencies);
			}
			world.scheduleUpdate(new BlockPos(x, y, z), this, this.tickRate(world));
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			...
			int j = y;
			int k = z;
			if ((bloodworldVariables.isPurifierRunning))
				for (int l = 0; l < 4; ++l) {
					...
					world.spawnParticle(EnumParticleTypes.SUSPENDED, d0, d1, d2, d3, d4, d5);
				}
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side,
			...
			Block block = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MCreatorBlockBloodPurifierOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return this.hasCustomName() ? this.customName : "container.blockbloodpurifier";
		}
