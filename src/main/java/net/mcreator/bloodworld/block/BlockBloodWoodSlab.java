...
public class BlockBloodWoodSlab extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:blood_wood_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("bloodworld:blood_wood_slab_double")
	public static final Block block_slab_double = null;
	public BlockBloodWoodSlab(ElementsBloodworldMod instance) {
		super(instance, 71);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blood_wood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("blood_wood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:blood_wood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("blood_wood_slab");
