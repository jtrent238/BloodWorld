...
public class BlockBlockBloodWoodPlanks extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:blockbloodwoodplanks")
	public static final Block block = null;
	public BlockBlockBloodWoodPlanks(ElementsBloodworldMod instance) {
		super(instance, 15);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blockbloodwoodplanks"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:blockbloodwoodplanks", "inventory"));
	}
