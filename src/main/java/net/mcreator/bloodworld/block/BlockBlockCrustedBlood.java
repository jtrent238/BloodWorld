...
public class BlockBlockCrustedBlood extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:blockcrustedblood")
	public static final Block block = null;
	public BlockBlockCrustedBlood(ElementsBloodworldMod instance) {
		super(instance, 29);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blockcrustedblood"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:blockcrustedblood", "inventory"));
	}
