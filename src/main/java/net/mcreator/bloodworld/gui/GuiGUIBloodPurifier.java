...
package net.mcreator.bloodworld.gui;
...
public class GuiGUIBloodPurifier extends ElementsBloodworldMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiGUIBloodPurifier(ElementsBloodworldMod instance) {
		super(instance, 40);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 16, 12) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 34, 12) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 52, 12) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 16, 30) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 34, 30) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 52, 30) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 106, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 124, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(8, this.addSlotToContainer(new Slot(internal, 8, 142, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 106, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(10, this.addSlotToContainer(new Slot(internal, 10, 124, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(11, this.addSlotToContainer(new Slot(internal, 11, 142, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				BloodworldMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void actionPerformed(GuiButton button) {
			BloodworldMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
