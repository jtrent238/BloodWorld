...
public class MCreatorBlockBloodBlossom extends bloodworld.ModElement {

	@GameRegistry.ObjectHolder("bloodworld:blockbloodblossom")
	public static final Block block = null;

	public MCreatorBlockBloodBlossom(bloodworld instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("bloodworld:blockbloodblossom",
				"inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("blockbloodblossom");
			setRegistryName("blockbloodblossom");
		}
