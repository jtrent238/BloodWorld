...
public class MCreatorPlantBloodshroom0 extends bloodworld.ModElement {

	@GameRegistry.ObjectHolder("bloodworld:plantbloodshroom0")
	public static final Block block = null;

	public MCreatorPlantBloodshroom0(bloodworld instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("bloodworld:plantbloodshroom0",
				"inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("plantbloodshroom0");
			setRegistryName("plantbloodshroom0");
		}
