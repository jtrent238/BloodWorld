...
public class MCreatorBlockBloodFlower2 extends bloodworld.ModElement {

	@GameRegistry.ObjectHolder("bloodworld:blockbloodflower2")
	public static final Block block = null;

	public MCreatorBlockBloodFlower2(bloodworld instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("bloodworld:blockbloodflower2",
				"inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("blockbloodflower2");
			setRegistryName("blockbloodflower2");
		}
