...
package net.mcreator.bloodworld.entity;
...
import net.mcreator.bloodworld.procedure.ProcedureEntityBloodSuckerPlayerCollidesWithThisMob;
...
public class EntityEntityBloodSucker extends ElementsBloodworldMod.ModElement {
	public static final int ENTITYID = 1;
	public static final int ENTITYID_RANGED = 2;
	public EntityEntityBloodSucker(ElementsBloodworldMod instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("bloodworld", "entitybloodsucker"), ENTITYID)
						.name("entitybloodsucker").tracker(64, 3, true).egg(-3407872, -6750208).build());
	}
	...
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemItemDropOfBlood.block, (int) (1)).getItem();
		}
		...
		public void onCollideWithPlayer(EntityPlayer entity) {
			...
			int z = (int) this.posZ;
			{
				...
				ProcedureEntityBloodSuckerPlayerCollidesWithThisMob.executeProcedure($_dependencies);
			}
		}
