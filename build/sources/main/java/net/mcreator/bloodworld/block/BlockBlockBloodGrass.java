...
public class BlockBlockBloodGrass extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:blockbloodgrass")
	public static final Block block = null;
	public BlockBlockBloodGrass(ElementsBloodworldMod instance) {
		super(instance, 38);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:blockbloodgrass", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("blockbloodgrass");
			setRegistryName("blockbloodgrass");
		}
