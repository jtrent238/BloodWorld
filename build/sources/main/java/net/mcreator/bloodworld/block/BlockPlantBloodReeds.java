...
public class BlockPlantBloodReeds extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:plantbloodreeds")
	public static final Block block = null;
	public BlockPlantBloodReeds(ElementsBloodworldMod instance) {
		super(instance, 45);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:plantbloodreeds", "inventory"));
	}
