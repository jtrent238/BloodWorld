...
public class BlockBlockBloodFlower extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:blockbloodflower")
	public static final Block block = null;
	public BlockBlockBloodFlower(ElementsBloodworldMod instance) {
		super(instance, 9);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:blockbloodflower", "inventory"));
	}
