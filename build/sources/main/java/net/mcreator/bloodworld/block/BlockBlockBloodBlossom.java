...
public class BlockBlockBloodBlossom extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:blockbloodblossom")
	public static final Block block = null;
	public BlockBlockBloodBlossom(ElementsBloodworldMod instance) {
		super(instance, 37);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:blockbloodblossom", "inventory"));
	}
