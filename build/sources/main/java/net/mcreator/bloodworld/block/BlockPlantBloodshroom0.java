...
public class BlockPlantBloodshroom0 extends ElementsBloodworldMod.ModElement {
	@GameRegistry.ObjectHolder("bloodworld:plantbloodshroom0")
	public static final Block block = null;
	public BlockPlantBloodshroom0(ElementsBloodworldMod instance) {
		super(instance, 39);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("bloodworld:plantbloodshroom0", "inventory"));
	}
