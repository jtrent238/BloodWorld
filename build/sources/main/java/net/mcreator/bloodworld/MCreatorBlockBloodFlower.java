...
public class MCreatorBlockBloodFlower extends bloodworld.ModElement {

	@GameRegistry.ObjectHolder("bloodworld:blockbloodflower")
	public static final Block block = null;

	public MCreatorBlockBloodFlower(bloodworld instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("bloodworld:blockbloodflower",
				"inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("blockbloodflower");
			setRegistryName("blockbloodflower");
		}
